...
"""Code template for the ROB Number predictor demo. Implement the predict
function to participate in the benchmark.
"""
...
def predict(values):
    """Number predictor. Takes a sequence of numbers as input. Returns the
    predicted next number in the sequence.
